  ...
  return (
    ...
    >
      ...
      <div className="relative max-w-5xl mx-auto px-6 text-center">
        ...
        <p className="text-3xl md:text-4xl lg:text-5xl font-bold text-[#000] leading-tight">
          How the Cross-Catchment Collective
          <br className="hidden md:block" />
          Works
        </p>

        <p className="mt-8 text-lg md:text-xl lg:text-[30px] leading-relaxed text-[#2C2C2C] max-w-4xl mx-auto">
        ...
        <p className="mt-6 text-lg md:text-xl lg:text-[30px] leading-relaxed text-[#2C2C2C] max-w-4xl mx-auto">
